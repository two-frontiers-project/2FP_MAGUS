...
class ORFCaller:
    ...
    def call_bacterial_orfs(self, genome_file):
    ...
    def call_viral_orfs(self, genome_file):
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=args.max_workers) as executor:
        for genome_file in bacterial_files:
            executor.submit(orf_caller.call_bacterial_orfs, genome_file)
        for genome_file in viral_files:
            executor.submit(orf_caller.call_viral_orfs, genome_file)
        for genome_file in eukaryotic_files:
            executor.submit(orf_caller.call_eukaryotic_orfs, genome_file)
        for genome_file in metagenome_files:
            executor.submit(orf_caller.call_metagenome_orfs, genome_file)
