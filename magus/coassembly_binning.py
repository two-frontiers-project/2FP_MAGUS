...
class CoAssemblyBinning:
    def __init__(self, config, outdir="coasm", magdir=None, tmpdir=None, threads=48, checkm_db=None, max_workers=4, test_mode=False):
...
def main():
    ...
    parser.add_argument('--outdir', type=str, default="coasm", help='Output directory (default: coasm)')
    ...
    parser.add_argument('--test_mode', action='store_true', help='Enable test mode to allow all bins regardless of quality')
